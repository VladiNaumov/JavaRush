package com.NaumDeveloper.JavaRush;//Демонстрация  использования  класса  Queue. Создание  класса очереди
...
public class Main {
            ...
            public static void main(String args[]) {
                ...
                System.out.println("Иcпoльзoвaниe  очереди  srn allQ для  генерации ошибок");
                for (i=0;i<5;i++){
                ...
                //  Дополнительные  ошибки  при  обращении  к  очереди  srn allQ
